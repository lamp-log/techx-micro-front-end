        ...
        <div className="bg-gray-800 p-8 rounded-lg shadow-xl border border-gray-700">
          ...
          <div className="bg-gray-900 rounded-lg p-6 border border-gray-700">
            <div className="space-y-3">
              ...
              >
                <h3 className="font-semibold text-blue-400 mb-1">/remote/page1</h3>
                <p className="text-gray-400 text-sm">Demo page showing integration capabilities</p>
              </Link>
              <Link 
                to="/page2"
              ...
              >
                <h3 className="font-semibold text-purple-400 mb-1">/remote/page2</h3>
                <p className="text-gray-400 text-sm">Feature showcase with multiple sections</p>
              </Link>
            </div>
